...
@EnableScan
public interface VersioningPromptRepository extends CrudRepository<VersioningPrompt, UUID> {
    // promptNamePromptVersionIndex 사용
    List<VersioningPrompt> findAllByPromptName(String promptName);
    VersioningPrompt findByPromptNameAndPromptVersion(String promptName, String promptVersion);
}
